...
public class FileValidator {
	...
	public ValidationResult validateFileUpload(FileUploadRequest request) {
		...
		if (request.getFileSize() > maxFileSize) {
			result.addError("File size exceeds maximum allowed size of " +
	...
	public ValidationResult validateChunkedUpload(
			com.feng.storage.service.api.ChunkedUploadRequest request) {
