...
The Calendar Service is a robust, scalable system designed to determine whether a given
date is a holiday, work date, or weekend. It provides APIs to check date types and find
the next/previous work dates, supporting multiple countries, time zones, and custom
business calendars.
...
**Scenario**: A project management tool calculates delivery dates excluding weekends and
holidays.
