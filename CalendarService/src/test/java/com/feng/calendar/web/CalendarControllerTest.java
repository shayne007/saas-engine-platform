...
class CalendarControllerTest {
    ...
    void testGetDateType() throws Exception {
        ...
        when(calendarService.checkDateType(eq(date), eq("US"), anyString(), anyString()))
    ...
    void testGetNextWorkDate() throws Exception {
        ...
        when(calendarService.findNextWorkDate(eq(fromDate), eq("US"), anyString(), anyBoolean()))
            .thenReturn(expectedResponse);
        ...
        mockMvc.perform(get("/api/v1/calendar/next-work-date")
            ...
            .andExpect(jsonPath("$.skippedDates[0].reason").value("Independence Day Holiday"));
    }
