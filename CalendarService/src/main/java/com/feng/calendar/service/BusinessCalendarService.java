...
public class BusinessCalendarService {
	...
	public Optional<BusinessCalendarRule> getCustomRule(LocalDate date,
			String businessCalendarId) {
		try {
			Long calendarId = Long.parseLong(businessCalendarId);
			return businessCalendarRuleRepository.findByCalendarIdAndDate(calendarId,
					date);
		}
	 ...
	 */
	public Optional<BusinessCalendar> getBusinessCalendarByOrganizationAndCountry(
			String organizationId, String countryCode) {
		return businessCalendarRepository.findByOrganizationIdAndCountryCode(
	 ...
	 */
	public java.util.List<BusinessCalendarRule> getRulesForDateRange(Long calendarId,
			LocalDate startDate, LocalDate endDate) {
		return businessCalendarRuleRepository.findByCalendarIdAndDateRange(calendarId,
				startDate, endDate);
	}
